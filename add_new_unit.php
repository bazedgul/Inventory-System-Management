...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"><a href="add_new_unit.php" title="Go to Add New Unit" class="tip-bottom"><i
                    class="icon-home"></i>
                Add New Unit</a></div>
    </div>
    <!--End-breadcrumbs-->
                ...
                while($row = mysqli_fetch_array($res)) 
                {
                    ?>
                        <tr>
                          ...
                          <td> <center> <a href="edit_unit.php?id=<?php  echo $row['id']; ?>" 
                          onMouseOver="this.style.color='green'" 
                          onMouseOut="this.style.color='blue'" 
                          >Edit</a> </center></td>
                          <td> <center> <a href="delete_unit.php?id=<?php echo $row["id"] ?>" 
