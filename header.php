...
<div id="header">
    ...
    <h2 style="color: white;position: absolute">
        <a href="dashboard.html" style="color:white; margin-left: 30px; margin-top: 40px">BG IMS</a>
    </h2>
</div>
...
<div id="sidebar">
    <ul>
        ...
        <li >
            <a href="purchase_master.php"><i class="icon icon-user"></i><span>Add New Purshase</span></a>
        </li>
